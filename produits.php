...
<div class="container">
    ...
    <div class="col-ms-11  col-md-5 col-lg-3  p-0 card  border-0 shadow gap-3  d-flex flex-column align-items-center  ">
        ...
        <img  class="h-50 w-75 pt-3" src="images/groupe.png" alt="img">
    ...
    <div class="col-ms-11  col-md-5 col-lg-3  p-0 card  border-0 shadow gap-3  d-flex flex-column align-items-center  ">
        ...
        <img  class="h-50 w-75 pt-3" src="images/trax3.png" alt="img">
        <div class=" w-100   d-flex align-items-center">
            <span class="text-start ps-2 text-white bg-price p-2">400 Dhs</span>
        </div>
    ...
    <div class="col-ms-11  col-md-5 col-lg-3  p-0 card  border-0 shadow gap-3  d-flex flex-column align-items-center  ">
        ...
        <img  class="h-50 w-75 pt-3" src="images/post_sodage.png" alt="img">
        <div class=" w-100   d-flex align-items-center">
            <span class="text-start ps-2 text-white bg-price p-2">400 Dhs</span>
        </div>
    ...
    <div class="col-ms-11  col-md-5 col-lg-3  p-0 card  border-0 shadow gap-3  d-flex flex-column align-items-center  ">
        ...
        <img  class="h-50 w-75 pt-3" src="images/perforateur.png" alt="img">
        <div class=" w-100   d-flex align-items-center">
            <span class="text-start ps-2 text-white bg-price p-2">400 Dhs</span>
        </div>
    ...
    <div class="col-ms-11  col-md-5 col-lg-3  p-0 card  border-0 shadow gap-3  d-flex flex-column align-items-center  ">
        ...
        <img  class="h-50 w-75 pt-3" src="images/hilti.png" alt="img">
        <div class=" w-100   d-flex align-items-center">
            <span class="text-start ps-2 text-white bg-price p-2">400 Dhs</span>
        </div>
    ...
    <div class="col-ms-11  col-md-5 col-lg-3  p-0 card  border-0 shadow gap-3  d-flex flex-column align-items-center  ">
        ...
        <img  class="h-50 w-75 pt-3" src="images/la_meule.png" alt="img">
        <div class=" w-100   d-flex align-items-center">
            <span class="text-start ps-2 text-white bg-price p-2">400 Dhs</span>
        </div>

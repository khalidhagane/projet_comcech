            ...
            <div class="col px-0">
                ...
                <div class="bg-light py-2  ">
                        <div class="d-flex  align-items-center  justify-content-center justify-content-sm-between  mt-3">
                            ...
                            <form method="POST" action="<?php echo URLROOT ?>/PromotionController/update_promotion/<?= $data['id']; ?>" enctype="multipart/form-data" >
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleInputPassword1" class="form-label">prix</label>
                                        <input type="number" name="prix2"  class="form-control" value='<?php echo $data['prix2']; ?>'  id="exampleInputPassword1">
                                    </div>
                                    <div class="mb-3">
